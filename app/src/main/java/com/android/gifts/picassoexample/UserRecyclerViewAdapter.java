    ...
    public void onBindViewHolder(UserViewHolder holder, int position) {
        ...
        * */
        ...
        picasso.load(thisUser.image)
                ...
                .placeholder(R.drawable.image_placeholder) // display this image while loading images
                .error(R.drawable.on_fail) // Loaded if URL is wrong or failed to load resources
